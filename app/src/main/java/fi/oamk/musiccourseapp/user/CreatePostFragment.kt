    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        submit.setOnClickListener{
            ...
            submit.setOnClickListener {
                ...
                if (hour1.isChecked){
                    database.child("hours").child(key1).child("start").setValue(hour1.text.toString())
                ...
                if(hour2.isChecked){
                    database.child("hours").child(key2).child("start").setValue(hour2.text.toString())
                ...
                if(hour3.isChecked){
                    database.child("hours").child(key3).child("start").setValue(hour3.text.toString())
                ...
                if(hour4.isChecked){
                    database.child("hours").child(key4).child("start").setValue(hour4.text.toString())
                ...
                if(hour5.isChecked){
                    database.child("hours").child(key5).child("start").setValue(hour5.text.toString())
                ...
                if(hour6.isChecked){
                    database.child("hours").child(key6).child("start").setValue(hour6.text.toString())
                ...
                if(hour7.isChecked){
                    database.child("hours").child(key7).child("start").setValue(hour7.text.toString())
                ...
                if(hour8.isChecked){
                    database.child("hours").child(key8).child("start").setValue(hour8.text.toString())
                ...
                if(hour9.isChecked){
                    database.child("hours").child(key9).child("start").setValue(hour9.text.toString())
                ...
                if(hour10.isChecked){
                    database.child("hours").child(key10).child("start").setValue(hour10.text.toString())
                ...
                if(hour11.isChecked){
                    database.child("hours").child(key11).child("start").setValue(hour11.text.toString())
                ...
                if(hour12.isChecked){
                    database.child("hours").child(key12).child("start").setValue(hour12.text.toString())
